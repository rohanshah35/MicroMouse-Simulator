...
private:
    ...
    void updatePosition(int currentDirection, int &x, int &y, int &leftCount, int &forwardCount, int &rightCount, int (mousePosition)[20][20]);
    void updateCoordinates(int currentDirection, int &x, int &y);
